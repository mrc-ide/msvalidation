...
#TODO: what is the shape of SP?
Non_ACT <- SP_AQ_params
Non_ACT[[1]] <- 0.75 #efficacy

ACT <- AL_params

SMC_drug <- SP_AQ_params
SMC_drug[[3]] <- 3.66
SMC_drug[[4]] <- 36.63 # updated SP-AQ fits based on Gina's results

# new
IM <- params %>% 
  set_drugs(list(Non_ACT, ACT, SMC_drug)) %>% 
